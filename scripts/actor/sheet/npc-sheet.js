 ...
 *
 * ActorSheetwfrp3NPC is assigned to NPC type actors, and the specific interactions
 ...
 * 
 */
class ActorSheetwfrp3NPC extends ActorSheetwfrp3
{
  static get defaultOptions()
  {
    ...
    mergeObject(options,
    {
      classes: options.classes.concat(["wfrp3", "actor", "npc-sheet"]),
      width: 610,
      height: 740,
    });
    return options;
  ...
  get template()
  {
    ...
    return "systems/wfrp3/templates/actors/npc-sheet.html";
  }
...
// Register NPC Sheet
Actors.registerSheet("wfrp3", ActorSheetwfrp3NPC,
{
  types: ["npc"],
  makeDefault: true
});