 ...
 *
 * ActorSheetwfrp3Creature is assigned to Creature type actors, which have a very 
 ...
 * 
 */
class ActorSheetwfrp3Creature extends ActorSheetwfrp3
{
  static get defaultOptions()
  {
    ...
    mergeObject(options,
    {
      classes: options.classes.concat(["wfrp3", "actor", "creature-sheet"]),
      width: 610,
      height: 740,
    });
    return options;
  ...
  get template()
  {
    ...
    return "systems/wfrp3/templates/actors/creature-sheet.html";
  }
  ...
  _onTraitClick(traitId, include)
  {
    ...
    let bonuses = wfrp3.traitBonuses[trait.name.toLowerCase()]
...
Actors.registerSheet("wfrp3", ActorSheetwfrp3Creature,
{
  types: ["creature"],
  makeDefault: true
});