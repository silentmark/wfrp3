...
Hooks.once("init", () => {
    ...
    FilePicker.browse("data", "systems/wfrp3/tables").then(resp => {
      try 
      {
      if (resp.error)
        throw ""
    ...
    game.settings.register("wfrp3", "systemMigrationVersion", {
    ...
    game.settings.register("wfrp3", "initiativeRule", {
      ...
      onChange: rule => _setwfrp3Initiative(rule)
    });
    _setwfrp3Initiative(game.settings.get("wfrp3", "initiativeRule"));
  
  
    function _setwfrp3Initiative(initMethod)
    {
      let formula;
      switch (initMethod)
      {
     ...
     game.settings.register("wfrp3", "capAdvantageIB", {
    ...
    game.settings.register("wfrp3", "fastSL", {
    ...
    game.settings.register("wfrp3", "testAbove100", {
    ...
    game.settings.register("wfrp3", "criticalsFumblesOnAllTests", {
      ...
      game.settings.register("wfrp3", "extendedTests", {
      ...
      game.settings.register("wfrp3", "testAutoFill", {
      ...
      // Register Test auto-fill
      game.settings.register("wfrp3", "autoFillAdvantage", {
      ...
      game.settings.register("wfrp3", "testDefaultDifficulty", {
      ...
      game.settings.register("wfrp3", "npcSpeciesCharacteristics", {
      ...
      game.settings.register("wfrp3", "partialChannelling", {
      ...
      game.settings.register("wfrp3", "displayRoundSummary", {
      ...
      game.settings.register("wfrp3", "statusOnTurnStart", {
      ...
      game.settings.register("wfrp3", "focusOnTurnStart", {
      ...
      game.settings.register("wfrp3", "hideTestData", {
      ...
      game.settings.register("wfrp3", "manualChatCards", {
      ...
      game.settings.register("wfrp3", "playerBrowser", {
      ...
      // Register Advantage cap
      game.settings.register("wfrp3", "soundEffects", {
      ...
      game.settings.register("wfrp3", "customCursor", {
      ...
      game.settings.register("wfrp3", "dangerousCrits", {
      ...
      game.settings.register("wfrp3", "dangerousCritsMod", {
    ...
    // Pre-load templates
    loadTemplates([
      "systems/wfrp3/templates/actors/actor-attributes.html",
      "systems/wfrp3/templates/actors/actor-abilities.html",
      "systems/wfrp3/templates/actors/actor-main.html",
      "systems/wfrp3/templates/actors/actor-combat.html",
      "systems/wfrp3/templates/actors/actor-biography.html",
      "systems/wfrp3/templates/actors/actor-inventory.html",
      "systems/wfrp3/templates/actors/actor-skills.html",
      "systems/wfrp3/templates/actors/actor-cards.html",
      "systems/wfrp3/templates/actors/actor-classes.html",
      "systems/wfrp3/templates/actors/actor-notes.html",
      "systems/wfrp3/templates/actors/npc-main.html",
      "systems/wfrp3/templates/actors/npc-notes.html",
      "systems/wfrp3/templates/actors/creature-main.html",
      "systems/wfrp3/templates/actors/creature-notes.html",
      "systems/wfrp3/templates/actors/creature-main.html",
      "systems/wfrp3/templates/chat/dialog-constant.html",
      "systems/wfrp3/templates/chat/test-card.html",
      "systems/wfrp3/templates/chat/chat-command-display-info.html",
      "systems/wfrp3/templates/items/item-header.html",
      "systems/wfrp3/templates/items/item-description.html",
      "systems/wfrp3/templates/token-overlay.html"
    ]);
