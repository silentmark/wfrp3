class Migration
{
  ...
  {
    ui.notifications.notify("Beginning Migration to wfrp3 1.0")
    ...
    ui.notifications.notify("Migration to wfrp3 1.0 Finished")

    game.settings.set("wfrp3", "systemMigrationVersion", game.system.data.version)
  ...
  static migrateWeaponData(weaponData)
  {
    ...
    {
      let isMelee = wfrp3.groupToType[weaponData.data.weaponGroup.value] == "melee"
