...
class Marketwfrp3 {
    ...
    static testForAvailability({settlement, rarity, modifier}) {
        //This method read the table wfrp3.availabilityTable defined in the config file

        //First we get the different settlements size
        let validSettlements = Object.getOwnPropertyNames(wfrp3.availabilityTable);
        ...
        if (settlement && validSettlementsLocalized.hasOwnProperty(settlement)) {
            let validRarity = Object.getOwnPropertyNames(wfrp3.availabilityTable[validSettlementsLocalized[settlement]]);
        ...
        //Everything is ok, lets roll for availability
            ...
            let availabilityLookup = wfrp3.availabilityTable[validSettlementsLocalized[settlement]][validRarityLocalized[rarity]];
    ...
    static generateSettlementChoice(rarity) {
        let cardData = {rarity: wfrp3.availability[rarity]};
        renderTemplate("systems/wfrp3/templates/chat/market-settlement.html", cardData).then(html => {
     ...
     * @param {Array} moneyItemInventory
     * @param transactionType wfrp3.transactionType, is it a payment or an income
     */
    ...
    static generatePayCard(payRequest) {
        ...
        } else //generate a card with a summary and a pay button
        {
            ...
            renderTemplate("systems/wfrp3/templates/chat/market-pay.html", cardData).then(html => {
     ...
     * @param {wfrp3.creditOptions} option
     */
    static generateCreditCard(creditRequest, option) {
        ...
        } else //generate a card with a summary and a receive button
        {
            ...
            else if (option.toLowerCase() ===wfrp3.creditOptions.SPLIT.toLowerCase() ) 
            {
            ...
            else if ( option.toLowerCase() === wfrp3.creditOptions.EACH.toLowerCase() )  
            {
            ...
            renderTemplate("systems/wfrp3/templates/chat/market-credit.html", cardData).then(html => {
