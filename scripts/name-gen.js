...
class NameGenWfrp
{
  static _loadNames()
  {
    console.log("wfrp3 | Loading Names...")

    // Surname option 1
    fetch("systems/wfrp3/names/human_surnames.txt").then(r => r.text()).then(async nameText =>
    {
      this.surnames = []
    ...
    fetch("systems/wfrp3/names/human_surnames_prefix.txt").then(r => r.text()).then(async nameText =>
    {
    ...
    fetch("systems/wfrp3/names/human_surnames_suffix.txt").then(r => r.text()).then(async nameText =>
    {
    ...
    // Male forenames
    fetch("systems/wfrp3/names/male_human_forenames.txt").then(r => r.text()).then(async nameText =>
    {
    ...
    // Female forenames
    fetch("systems/wfrp3/names/female_human_forenames.txt").then(r => r.text()).then(async nameText =>
    {
    ...
    // @@@@@@@@@@ DWARF @@@@@@@@@@@@@
    // male forenames
    fetch("systems/wfrp3/names/male_dwarf_forenames.txt").then(r => r.text()).then(async nameText =>
      {
    ...
    // Female forenames
    fetch("systems/wfrp3/names/female_dwarf_forenames.txt").then(r => r.text()).then(async nameText =>
      {
    ...
    // @@@@@@@@@@ ELF @@@@@@@@@@@@@
        // elf forenames
        fetch("systems/wfrp3/names/elf_forenames.txt").then(r => r.text()).then(async nameText =>
          {
            this.elf_Forenames = []
          ...
          fetch("systems/wfrp3/names/elf_surnames.txt").then(r => r.text()).then(async nameText =>
            {
              this.elf_surnames = []
        ...
        // elf start
        fetch("systems/wfrp3/names/elf_start.txt").then(r => r.text()).then(async nameText =>
          {
            this.elf_start = []
      ...
      // elf connector
      fetch("systems/wfrp3/names/elf_connectors.txt").then(r => r.text()).then(async nameText =>
        {
          this.elf_connectors = []
          nameText.split("\n").forEach((nameGroup) => this.elf_connectors.push(nameGroup.split(",").map(function (item)
          {
            return item.trim()
              ...
              // female elf element
      fetch("systems/wfrp3/names/male_elf_element.txt").then(r => r.text()).then(async nameText =>
        {
          ...
          nameText.split("\n").forEach((nameGroup) => this.elf_male_element.push(nameGroup.split(",").map(function (item)
          {
            return item.trim()
              ...
              // male elf element
      fetch("systems/wfrp3/names/female_elf_element.txt").then(r => r.text()).then(async nameText =>
        {
        ...
        // wood elf end
      fetch("systems/wfrp3/names/elf_wood_end.txt").then(r => r.text()).then(async nameText =>
        {
          this.elf_wood_end = []
        ...
        // high elf end
      fetch("systems/wfrp3/names/elf_high_end.txt").then(r => r.text()).then(async nameText =>
        {
          this.elf_high_end = []
    ...
    // @@@@@@@@@@ Halfling @@@@@@@@@@@@@
    // Halfling start
    fetch("systems/wfrp3/names/halfling_start.txt").then(r => r.text()).then(async nameText =>
      {
        this.halfling_start = []
    ...
    // Male ending
    fetch("systems/wfrp3/names/male_halfling_element.txt").then(r => r.text()).then(async nameText =>
      {
        ...
        nameText.split("\n").forEach((nameGroup) => this.male_halfling_element.push(nameGroup.split(",").map(function (item)
        {
          ...
          // Female ending
    fetch("systems/wfrp3/names/female_halfling_element.txt").then(r => r.text()).then(async nameText =>
      {
      ...
      // Halfling surnames
      fetch("systems/wfrp3/names/halfling_surnames.txt").then(r => r.text()).then(async nameText =>
        {
        ...
        // Halfling nicknames
        fetch("systems/wfrp3/names/halfling_nicknames.txt").then(r => r.text()).then(async nameText =>
          {
